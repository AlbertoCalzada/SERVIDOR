...

{
	 ...
	 * 
	 * Connection c; c =
	 * DriverManager.getConnection("jdbc:mysql://localhost:3306/agendaJava", "root",
	 * ""); Statement stmt = c.createStatement(); String name = contacto.getName();
	 * int edad = contacto.getEdad(); String telefono = contacto.getTlf(); String
	 * sql =
	 * "INSERT INTO `contactos`(`nombre`, `telefono`, `edad`) VALUES (name,telefono,edad,)"
	 * ; stmt.executeUpdate(sql); stmt.close(); } catch (SQLException e) { // TODO
