...
public static String crearTabla(ArrayList<Entrenamiento> lista_entrenos)
{
	...
	for (int i=0; i<lista_entrenos.size(); i++)
	{
		...
		tabla+="<td>"+e.getEjercicios()[1]+"<br>"+"<i>"+e.getObservaciones()[1]+"</i>"+"</td>";
		tabla+="<td>"+e.getEjercicios()[0]+"<br>"+"<i>"+e.getObservaciones()[0]+"</i>"+"</td>";
		tabla+="<td>"+e.getEjercicios()[2]+"<br>"+"<i>"+e.getObservaciones()[2]+"</i>"+"</td>";
		tabla+="<td>"+e.getEjercicios()[3]+"<br>"+"<i>"+e.getObservaciones()[3]+"</i>"+"</td>";
		tabla+="</tr>";
